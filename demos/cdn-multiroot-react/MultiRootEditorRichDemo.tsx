...
import {
	...
	type WithCKEditorCloudHocProps, type MultiRootHookProps
} from '../../src/index.js';
...
const MultiRootEditorRichDemo = withCKCloud( ( props: EditorDemoProps ): JSX.Element => {
	const MultiRootEditor = useCKCdnMultiRootEditor( props.cloud );
