		...
		plugins: {
			Wiris: {
				scripts: [
					...
					'https://cdn.jsdelivr.net/npm/@wiris/mathtype-ckeditor5@8.10.0/dist/browser/index.umd.js'
				],
				stylesheets: [
					'https://cdn.jsdelivr.net/npm/@wiris/mathtype-ckeditor5@8.10.0/dist/browser/index.css'
				],
				getExportedEntries: () => window[ '@wiris/mathtype-ckeditor5' ]
			}
		}
	} );
